const Apps = [
    { id: 1, title: 'My Computer', icon: '/assets/icons/my-computer.png', position: { x: 50, y: 150 },onClick:"My Computer",size:{ width: 400, height: 300 } }, 
    { id: 2, title: 'Recycle Bin', icon: '/assets/icons/recycle-bin.png', position: { x: 150, y: 150 },onClick:'Recycle Bin',size:{ width: 400, height: 300 } },
    { id: 3, title: 'File', icon: '/assets/icons/folder.png', position: { x: 300, y: 150 },onClick:'File',size:{ width: 400, height: 300 } },
    { id: 4, title: 'Grapher', icon: '/assets/icons/grapher.png', position: { x: 450, y: 150 },onClick:'Iframe',url:"https://fernando29hernandez.github.io/grapher/#",size:{ width: 1000, height: 600 } },
